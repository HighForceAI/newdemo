...
export default function DashboardPage() {
  ...
  // Render search bar component separately for AppLayout
  const searchBar = (
  ...
  return (
    <AppLayout showSearchBar={true} searchBarComponent={searchBar}>
      {/* Loading overlay */}
      {!isLoaded && (
      ...
      <div
        className={`overflow-y-auto p-8 pt-12 transition-opacity duration-1000 ease-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
